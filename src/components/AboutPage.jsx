...
const AboutPage = () => (
  <MainLayout pageTitle="About Me">
    <InfoCard title="About Me" className="about-info-card">
      ...
      <p>And I am a student at Digitale Talenter in Norway, where i am currently learning frontend development and a bit of backend development. my short term goal is to become a fullstack developer, and i want to turn the knowledge i learned from it into a career as a ethical hacker.<br></br></p>
